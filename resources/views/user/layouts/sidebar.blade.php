...
<a href="{{ route('Beranda') }}" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-cream/60 hover:bg-[#7B1C2E] hover:text-white transition-all group">
    <i data-lucide="arrow-left-circle" class="h-4 w-4 text-cream/30 group-hover:text-gold transition-colors"></i>
