...
<head>
    ...
    <title>Formulir Sewa — Sanggar Rantiang Tagok</title>
...
<body class="min-h-screen bg-[#FAF3E0] text-[#4A0F1A] antialiased">
    ...
    <div class="mx-auto max-w-2xl px-6 pt-32 pb-24">
        ...
        {{-- Judul --}}
        <div class="mb-8">
            <p class="text-[10px] tracking-[0.4em] text-[#C8960C] uppercase font-semibold">— PEMESANAN SEWA —</p>
            <h1 class="mt-1 font-serif text-3xl font-light text-[#4A0F1A] md:text-4xl">Formulir Sewa Barang</h1>
            ...
            <form action="{{ route('user.pemesanan.store') }}" method="POST"
                ...
                <div x-show="step === 2" x-transition.opacity style="display:none">
                    ...
                    <div class="space-y-5 p-7">
                        ...
                        <div>
                            <p class="mb-3 text-[10px] font-semibold uppercase tracking-[0.25em] text-[#4A0F1A]">Metode Pengambilan</p>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <label class="flex cursor-pointer items-start gap-3 rounded-2xl border p-4 transition"
                                       :class="deliveryMethod === 'ambil_sendiri'
                                    ...
                                    <input type="radio" name="metode_pengambilan" value="ambil_sendiri"
                                           x-model="deliveryMethod" class="mt-0.5 shrink-0 accent-[#C8960C]">
                                    <div>
                                        <p class="text-sm font-semibold text-[#4A0F1A]">Ambil Sendiri</p>
                                        <p class="mt-0.5 text-xs text-[#4A2E28]">Datang ke sanggar langsung</p>
                                    </div>
                                </label>
                                <label class="flex cursor-pointer items-start gap-3 rounded-2xl border p-4 transition"
                                       :class="deliveryMethod === 'dikirim'
                                           ? 'border-[#C8960C] bg-[#C8960C]/6'
                                           : 'border-[#E2D4C0] hover:border-[#C8960C]/50'">
                                    <input type="radio" name="metode_pengambilan" value="dikirim"
                                           x-model="deliveryMethod" class="mt-0.5 shrink-0 accent-[#C8960C]">
                                    <div>
                                        <p class="text-sm font-semibold text-[#4A0F1A]">Dikirim</p>
                        ...
                        <div x-show="deliveryMethod === 'dikirim'"
                             class="space-y-3 rounded-2xl border border-[#E2D4C0] bg-[#FAF3E0] p-4">
                    ...
                    <div class="space-y-5 p-7">
                        ...
                        <div class="overflow-hidden rounded-2xl border border-[#E2D4C0]">
                            <div class="flex items-center justify-between px-5 py-3.5 text-sm">
                                ...
                                <span class="font-semibold text-[#4A0F1A]">Rp <span x-text="formatRupiah(subtotal)"></span></span>
                            </div>
                            <div class="flex items-center justify-between border-t border-[#E2D4C0] px-5 py-3.5 text-sm"
                                 x-show="ongkosKirim > 0">
                                <span class="text-[#4A2E28]">Biaya Kirim</span>
