...
<head>
    ...
    <title>Formulir Pemesanan — SILART</title>
        ...
        <div x-data="orderForm()" x-init="initForm">
            ...
            <div class="mb-8 px-2">
                <div class="relative flex items-start justify-between">
                    ...
                    @foreach ([['Detail Pesanan','1'], ['Lokasi','2'], ['Pembayaran','3']] as [$label, $num])
                ...
                <div x-show="step === 3" x-transition.opacity style="display:none">
                    ...
                    <div class="space-y-5 p-4 sm:p-7">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <label class="flex cursor-pointer items-center gap-4 rounded-2xl border p-4 transition"
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm font-semibold text-[#4A0F1A]">Bayar DP 50%</p>
                        ...
                        <div class="flex items-start gap-3 rounded-2xl border border-[#E2D4C0] bg-[#FAF3E0] px-4 py-3 text-xs text-[#4A2E28]">
                            ...
                            <p>Pesanan dikonfirmasi admin dalam 1×24 jam. Transfer pembayaran dilakukan setelah konfirmasi.</p>
                        </div>
                    </div>
