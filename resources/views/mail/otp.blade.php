            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
                ...
                <tr>
                    <td style="background-color:#E8F5E9;padding:14px 40px;border-bottom:1px solid #A5D6A7;">
                        <p style="margin:0;font-size:13px;font-weight:700;color:#2E7D32;text-align:center;">🔐 &nbsp; KODE OTP RESET PASSWORD</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:36px 40px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                            <tr>
                                <td align="center">
                                    <div style="background-color:#FAF3E0;border:2px dashed #D4AF37;border-radius:10px;padding:24px 40px;display:inline-block;">
                                        <p style="margin:0 0 8px 0;font-size:11px;letter-spacing:2px;text-transform:uppercase;color:#888;">Kode OTP Anda</p>
                                        <p style="margin:0;font-size:36px;font-weight:700;letter-spacing:10px;color:#800000;font-family:monospace;">{{ $otp }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding:14px 18px;">
                                    <p style="margin:0;font-size:13px;color:#800000;line-height:1.6;">
                                        Kode ini <strong>berlaku selama 10 menit</strong>. Jangan bagikan kode ini kepada siapapun. Jika Anda tidak merasa melakukan permintaan ini, abaikan email ini.
                                    </p>
                                </td>
                            </tr>
                        </table>
                        <p style="margin:0;font-size:14px;color:#555;line-height:1.6;">
                            Terima kasih telah mempercayai Sanggar Rantiang Tagok.
                        </p>
                    </td>
                </tr>
                <tr>
