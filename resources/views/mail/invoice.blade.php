            ...
            <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
                ...
                <tr>
                    <td style="background-color:#E8F5E9;padding:14px 40px;border-bottom:1px solid #A5D6A7;">
                        <p style="margin:0;font-size:13px;font-weight:700;color:#2E7D32;text-align:center;">✅ &nbsp; PESANAN DIKONFIRMASI</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding:36px 40px;">
                        ...
                        <p style="margin:0 0 28px 0;font-size:15px;color:#555555;line-height:1.6;">
                            Pesanan Anda telah dikonfirmasi oleh admin. Silakan lihat invoice dan lakukan pembayaran sesuai ketentuan.
                        </p>
                                ...
                                <td style="padding:20px 24px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:6px 0;font-size:13px;font-weight:600;color:#333;">{{ $pemesanan->tanggal_pakai->format('d F Y') }}</td>
                                        </tr>
                                        <tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                            <tr>
                                <td align="center">
                                    <a href="{{ route('user.pemesanan.invoice', $pemesanan->id) }}" style="background-color:#800000;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-size:14px;font-weight:700;display:inline-block;">Lihat Invoice</a>
                                </td>
                            </tr>
                        </table>
