...
@section('content')
    ...
    <div class="admin-section">
        ...
        <div class="admin-page-header md:flex-row md:items-center md:justify-between">
            ...
            <a href="{{ route('admin.kategori.create', 'jasa') }}" class="admin-btn-primary">+ Tambah Kategori</a>
        </div>
                            ...
                            <tr class="hover:bg-[#FAF3E0]">
                                ...
                                <td class="admin-table-td text-right">
                                    <div class="flex justify-end gap-2">
                                        <a href="{{ route('admin.kategori.edit', ['tipe' => 'jasa', 'id' => $item->id]) }}"
                                            class="admin-btn-secondary px-4 py-2">Edit</a>
                                        <form
                                            action="{{ route('admin.kategori.destroy', ['tipe' => 'jasa', 'id' => $item->id]) }}"
                                            method="POST"
