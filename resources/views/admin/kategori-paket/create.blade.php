...
<div class="admin-section">
    ...
    <div class="admin-card p-6">
        <form action="{{ route('admin.kategori-paket.store') }}" method="POST" class="space-y-4">
            @csrf

            <div>
                <label class="admin-label">Nama Kategori *</label>
                <input name="nama" type="text" class="admin-input" value="{{ old('nama') }}" placeholder="Contoh: Paket Pernikahan" required>
            </div>
