        ...
        <div class="admin-page-header md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="admin-subtitle mt-1 text-sm">
                    Kelola kategori untuk data paket layanan sanggar.
                </p>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-[#E2D4C0]">
                        @forelse ($kategoriPakets as $kategori)
                            <tr class="hover:bg-[#FAF3E0]">
                                ...
                                <td class="admin-table-td">
                                    ...
                                    @else
                                        <div
                                            class="admin-thumb flex items-center justify-center text-xs font-semibold text-[#4A2E28]">
                                            IMG
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="admin-table-td text-sm text-[#4A2E28]">
                                    {{ $kategori->deskripsi }}
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="admin-table-td text-center text-[#7C6A58] py-8">
