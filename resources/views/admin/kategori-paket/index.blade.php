...
<div class="admin-section">
    ...
    <div class="admin-page-header md:flex-row md:items-center md:justify-between">
        ...
        <a href="{{ route('admin.kategori-paket.create') }}" class="admin-btn-primary">+ Tambah Kategori</a>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-[#E2D4C0]">
                        ...
                        <tr class="hover:bg-[#FAF3E0]">
                            ...
                            <td class="admin-table-td text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.kategori-paket.edit', $kategori->id) }}" class="admin-btn-secondary px-4 py-2">Edit</a>
                                    <form action="{{ route('admin.kategori-paket.destroy', $kategori->id) }}" method="POST" onsubmit="return confirmDelete(event, 'Apakah Anda yakin ingin menghapus kategori ini?')">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="admin-table-td text-center text-[#7C6A58] py-8">Belum ada data kategori paket.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
